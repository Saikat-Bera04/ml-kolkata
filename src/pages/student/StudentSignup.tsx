      ...
      <div className="w-full max-w-md">
        <div className="bg-card rounded-lg shadow-card-lg p-8">
          <div className="text-center mb-8">
            ...
            <h2 className="text-xl text-muted-foreground">Student Signup</h2>
          </div>
          ...
          <div className="mt-4 text-center">
            <Link to="/mentor/signup" className="text-sm text-muted-foreground hover:text-primary">
              Are you a mentor? Sign up here
            </Link>
          </div>
        </div>
      </div>
